...
impl Cpu {
    ...
    pub fn step(&mut self) {
        ...
        match self.reg.get_current_instr() {
            ...
            0x02 => {}                        /*Crashes. Stops the cycle from advancing  Kil, Implied   */
            0x03 => unimplemented!(),         /*bytes: 2 cycles: 8  A____=>____P RW izx  Slo, IndirectX */
            0x04 => run!(dop, zero_page),     /*bytes: 2 cycles: 3  _____=>_____ R_ zp   Nop, ZeroPage  */
            ...
            0x0C => run!(dop, absolute),      /*bytes: 3 cycles: 4  _____=>_____ R_ abs  Nop, Absolute  */
            ...
            0x12 => {}                        /*Crashes. Stops the cycle from advancing  Kil, Implied   */
            0x13 => unimplemented!(),         /*bytes: 2 cycles: 8  A____=>____P RW izy  Slo, IndirectY */
            0x14 => run!(dop, zero_page_x),   /*bytes: 2 cycles: 4  _____=>_____ R_ zpx  Nop, ZeroPageX */
            ...
            0x1C => run!(dop, absolute_x),    /*bytes: 3 cycles: 4* _____=>_____ R_ absx Nop, AbsoluteX */
            ...
            0x22 => {}                        /*Crashes. Stops the cycle from advancing  Kil, Implied   */
            ...
            0x32 => {}                        /*Crashes. Stops the cycle from advancing  Kil, Implied   */
            0x33 => unimplemented!(),         /*bytes: 2 cycles: 8  ____P=>A___P RW izy  Rla, IndirectY */
            0x34 => run!(dop, zero_page_x),   /*bytes: 2 cycles: 4  _____=>_____ R_ zpx  Nop, ZeroPageX */
            ...
            0x3C => run!(dop, absolute_x),    /*bytes: 3 cycles: 4* _____=>_____ R_ absx Nop, AbsoluteX */
            ...
            0x42 => {}                        /*Crashes. Stops the cycle from advancing  Kil, Implied   */
            0x43 => unimplemented!(),         /*bytes: 2 cycles: 8  A____=>____P RW izx  Sre, IndirectX */
            0x44 => run!(dop, zero_page),     /*bytes: 2 cycles: 3  _____=>_____ R_ zp   Nop, ZeroPage  */
            ...
            0x52 => {}                        /*Crashes. Stops the cycle from advancing  Kil, Implied   */
            0x53 => unimplemented!(),         /*bytes: 2 cycles: 8  A____=>____P RW izy  Sre, IndirectY */
            0x54 => run!(dop, zero_page_x),   /*bytes: 2 cycles: 4  _____=>_____ R_ zpx  Nop, ZeroPageX */
            ...
            0x5C => run!(dop, absolute_x),    /*bytes: 3 cycles: 4* _____=>_____ R_ absx Nop, AbsoluteX */
            ...
            0x62 => {}                        /*Crashes. Stops the cycle from advancing  Kil, Implied   */
            0x63 => unimplemented!(),         /*bytes: 2 cycles: 8  A___P=>A___P RW izx  Rra, IndirectX */
            0x64 => run!(dop, zero_page),     /*bytes: 2 cycles: 3  _____=>_____ R_ zp   Nop, ZeroPage  */
            ...
            0x72 => {}                        /*Crashes. Stops the cycle from advancing  Kil, Implied   */
            0x73 => unimplemented!(),         /*bytes: 2 cycles: 8  A___P=>A___P RW izy  Rra, IndirectY */
            0x74 => run!(dop, zero_page_x),   /*bytes: 2 cycles: 4  _____=>_____ R_ zpx  Nop, ZeroPageX */
            ...
            0x7C => run!(dop, absolute_x),    /*bytes: 3 cycles: 4* _____=>_____ R_ absx Nop, AbsoluteX */
            ...
            0x92 => {}                        /*Crashes. Stops the cycle from advancing  Kil, Implied   */
            ...
            0xA6 => run!(ldx, zero_page),     /*bytes: 2 cycles: 3  _____=>_X__P R_ zp   Ldx, ZeroPage  */
            ...
            0xAE => run!(ldx, absolute),      /*bytes: 3 cycles: 4  _____=>_X__P R_ abs  Ldx, Absolute  */
            ...
            0xB1 => run!(lda, indirect_y),    /*bytes: 2 cycles: 5* _____=>A___P R_ izy  Lda, IndirectY */
            0xB2 => {}                        /*Crashes. Stops the cycle from advancing  Kil, Implied   */
            ...
            0xB6 => run!(ldx, zero_page_y),   /*bytes: 2 cycles: 4  _____=>_X__P R_ zpy  Ldx, ZeroPageY */
            ...
            0xBE => run!(ldx, absolute_y),    /*bytes: 3 cycles: 4* _____=>_X__P R_ absy Ldx, AbsoluteY */
            ...
            0xD2 => {}                        /*Crashes. Stops the cycle from advancing  Kil, Implied   */
            0xD3 => unimplemented!(),         /*bytes: 2 cycles: 8  A____=>____P RW izy  Dcp, IndirectY */
            0xD4 => run!(dop, zero_page_x),   /*bytes: 2 cycles: 4  _____=>_____ R_ zpx  Nop, ZeroPageX */
            ...
            0xDC => run!(dop, absolute_x),    /*bytes: 3 cycles: 4* _____=>_____ R_ absx Nop, AbsoluteX */
            ...
            0xF2 => {}                        /*Crashes. Stops the cycle from advancing  Kil, Implied   */
            0xF3 => unimplemented!(),         /*bytes: 2 cycles: 8  A___P=>A___P RW izy  Isc, IndirectY */
            0xF4 => run!(dop, zero_page_x),   /*bytes: 2 cycles: 4  _____=>_____ R_ zpx  Nop, ZeroPageX */
            ...
            0xFC => run!(dop, absolute_x),   /*bytes: 3 cycles: 4* _____=>_____ R_ absx Nop, AbsoluteX */
